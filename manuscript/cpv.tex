...
Finally, we show that our method yields only 37 false-positive DMR's on 20
runs of shuffled of CHARM data (33 of those come from 2 of the sets, likely
...
We also show that \textit{comb-p} recovers more significant probes than
a simple FDR correction on the original p-values.
