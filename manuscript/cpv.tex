...
correction. This step first calculates the ACF out to the distance
of the largest region-size of all predicted peaks. The corrected
p-value for each peak is then calculated using the original p-values
that fall within the peak and the ACF.
