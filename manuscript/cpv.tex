...
each from a different statistical test.
...
\bibitem[Irizarry {\t et~al}., 2008]{Irizarry2008} Irizarry R.A. et al.
(2008). Comprehensive high-throughput arrays for relative methylation (CHARM).
{\it Genome Research}, {\bf 18}, 780-790.

\bibitem[Irizarry {\t et~al}., 2009]{Irizarry2009} Irizarry R.A. et al.
